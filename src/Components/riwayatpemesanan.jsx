    ...
    <div className="w-full px-2">
      ...
      <div className="flex flex-col md:flex-row justify-between space-y-2 md:space-y-0">
        <div className="flex flex-col md:flex-row items-center w-full space-y-4 md:space-y-0 md:space-x-4 text-black font-semibold">
          <select
            className="select-cst text-center ml-2 text-white rounded-md bg-[#00B7C2] hover:bg-gray-700 p-2 md:px-4 w-full md:w-auto mr-2 md:mr-0 flex items-center"
            value={filter}
      ...
      {filteredBooking.map((pemesanan) => (
        <div
          ...
          className="flight-ticket-card shadow-lg border rounded-md px-6 py-4 text-sm text-black dark:text-white font-bold w-full my-4 mx-auto border-opacity-50 max-w-full md:max-w-4xl"
        >
          <div className="flex flex-col md:flex-row items-center md:justify-between">
            <div className="flex items-center mb-2 md:mb-0">
              <img
                src={pemesanan.flight.airlines.url_logo}
                className="h-8 w-8 md:h-12 md:w-12 mr-2 rounded-full"
                alt="Airlines Logo"
              />
          ...
          <div className="flex flex-col md:flex-row justify-between my-3">
            <div className="flex flex-col items-start w-full md:w-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                <div className="flex items-center">
                  <FaLocationDot className="text-gray-700 dark:text-gray-400 " />
                  <p className="text-gray-700 dark:text-gray-400 font-semibold ml-2">
                    {pemesanan.flight.destination_airport.airport_name}
                  </p>
                </div>
                <div className="flex items-center justify-center ">
                  <FaArrowRight className="text-gray-700 mx-2 my-1 md:my-0 md:mx-0" />
                </div>
                <div className="flex items-center">
                  <FaLocationDot className="text-gray-700 dark:text-gray-400" />
                  <p className="text-gray-700 dark:text-gray-400 font-semibold ml-2">
