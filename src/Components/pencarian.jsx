                  ...
                  <div key={index} className="p-4 my-4 border border-gray-100 dark:border-gray-700 rounded-md max-w-7xl items-center justify-between mx-auto">
                    <div className="mx-8 bg-white shadow-lg rounded-lg outline-1 mb-4">
                      ...
                      <div className="flex flex-col sm:flex-row items-center sm:justify-end sm:items-center p-4">
                        <div className="text-gray-600 flex flex-col items-center sm:items-start mb-4 sm:mb-0">
                          {flight.price === flight.total_price ? (
                            <span className="font-bold text-[#00B7C2]">Rp {flight.total_price.toLocaleString("id-ID")}</span>
                          ) : (
                            <>
                              <p className="text-red-600 font-bold">
                                <span className="text-gray-500 line-through">Rp {flight.price.toLocaleString("id-ID")}</span> Rp {flight.total_price.toLocaleString("id-ID")}
                              </p>
                            </>
                          )}
                        </div>
...
//                       <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 py-4">
//                         <div className="flex flex-col items-center">
//                           <span className="text-gray-700 dark:text-gray-400 font-semibold">{formatDate(flight?.departure_time)}</span>
//                           <span className="text-gray-700 dark:text-gray-400 font-semibold">Pukul : {formatTime(flight?.departure_time)}</span>
//                           <span className="text-gray-700 dark:text-gray-400 font-semibold">
//                             {flight.destination_airport?.city} <span>({flight.destination_airport_id})</span>
//                           </span>
//                         </div>
...
//                         </div>
//                         <div className="flex flex-col items-center">
//                           <span className="text-gray-700 dark:text-gray-400 font-semibold">{formatDate(flight?.arrival_time)}</span>
...
//                           ) : (
//                             <>
//                               <p className="text-gray-500 line-through">Harga Normal: Rp {flight.price.toLocaleString("id-ID")}</p>
//                               <p className="text-red-600 font-bold">Harga Diskon: Rp {flight.total_price.toLocaleString("id-ID")}</p>
//                             </>
//                           )}
//                         </div>
//                         <Link to={`/detail/${flight?.flight_id}`} className="block text-center bg-gray-600 hover:bg-gray-800 text-white font-bold text-l py-2 px-4 rounded-md focus:outline-none sm:ml-4 mt-4 sm:mt-0">
